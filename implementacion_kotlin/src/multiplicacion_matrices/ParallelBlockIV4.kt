...
class ParallelBlockIV4 : AlgoritmoMultiplicacion {
    ...
    override fun multiplicar(matriz1: Array<Array<BigInteger>>, matriz2: Array<Array<BigInteger>>) {
        ...
        val doubleResultado = multiply(doubleMatriz1, doubleMatriz2, doubleMatriz1.size)
    ...
    fun multiply(matrix1: Array<IntArray>, matrix2: Array<IntArray>, blockSize: Int): Array<IntArray> {
        val m = matrix1.size
